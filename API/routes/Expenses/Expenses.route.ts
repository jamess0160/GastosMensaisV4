...
Expenses_route.get("/Expenses", Expenses_schema.getByWorkspace, AsyncHandler(Expenses_controller.getByWorkspace))

Expenses_route.get("/Expenses/IdExpense=:IdExpense", Expenses_schema.getUnique, AsyncHandler(Expenses_controller.getUnique))

Expenses_route.post("/Expenses", Expenses_schema.create, AsyncHandler(Expenses_controller.create))

Expenses_route.put("/Expenses/IdExpense=:IdExpense", Expenses_schema.update, AsyncHandler(Expenses_controller.update))
...
Expenses_route.put("/Expenses/IdExpense=:IdExpense/series", Expenses_schema.updateSeries, AsyncHandler(Expenses_controller.updateSeries))

Expenses_route.delete("/Expenses/IdExpense=:IdExpense", Expenses_schema.remove, AsyncHandler(Expenses_controller.remove))

Expenses_route.delete("/Expenses/IdExpense=:IdExpense/series", Expenses_schema.removeSeries, AsyncHandler(Expenses_controller.removeSeries))
