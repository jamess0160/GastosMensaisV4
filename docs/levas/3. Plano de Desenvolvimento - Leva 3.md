...
| **6** | [Agregados do mês](#etapa-6--agregados-do-mês) | [3](../Pendencias%20Backend.md#3-agregados-do-mês-para-o-dashboard) | volume que ainda não existe; e as etapas 7 e 10 da leva 2 |
...
Duas das oito (1 e 2) poderiam começar hoje. As outras seis esperam infra, volume ou
