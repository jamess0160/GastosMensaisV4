...
| # | Pendência | Etapa | O que a trava |
| --- | --- | --- | --- |
| 4 | [Rotina mensal de orçamento](../Pendencias%20Backend.md#4-rotina-mensal-de-orçamento) | 1 | nada — é a mais pronta das sete |
| 5 | [Duração de sessão](../Pendencias%20Backend.md#5-duração-de-sessão-configurável) | 2 | nada; só prioridade |
| 6 | [Recuperação de senha](../Pendencias%20Backend.md#6-recuperação-de-senha) | 3 | **envio de e-mail**, que o projeto não tem |
| 9 | [Notificações](../Pendencias%20Backend.md#9-notificações) | 4 | **agendador** + definir o que gera aviso |
| 3 | [Agregados do mês](../Pendencias%20Backend.md#3-agregados-do-mês-para-o-dashboard) | 6 | volume que ainda não existe; e a etapa 7 da leva 2 |
| 8 | [Exportar para Excel](../Pendencias%20Backend.md#8-exportar-para-excel) | 7 | depende da etapa 6 |
| 7 | [Conciliação de extrato](../Pendencias%20Backend.md#7-conciliação-de-extrato) | 8 | **nada está especificado** |

Some-se a elas uma **demanda de produto** — o parâmetro de competência do cartão, decidido no
debate de 2026-09-04 —, que vira a etapa 5 e não tem pendência para citar.

Três das oito (1, 2 e 5) poderiam começar hoje. As outras cinco esperam infra, volume ou
...
- **O saldo não muda uma linha.** `AccountBalance` continua lendo `DueDate` e perna **paga**. O
  parâmetro responde "quanto eu gastei", nunca "quanto eu tenho" — misturar os dois faria a
  compra sair da conta antes de a fatura ser paga, que é o saldo plausível e errado que o projeto
  inteiro evita.
...
**Pendência 3** · **Pasta nova:** `routes/Reports/` · **Só quando o volume justificar**
...
saiu. As quatro escolhas abaixo foram fechadas no debate de 2026-09-04:

| | Posso gastar | Tenho em conta |
| --- | --- | --- |
| **Base de data** | competência — a `CompetenceDate` da perna, que a etapa 5 governa | caixa — `DueDate`, sempre, sem parâmetro nenhum |
