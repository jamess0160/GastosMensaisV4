...
expõe hoje**, conforme [API - Contrato Front-end.md](../../Contrato%20Front-end/API%20-%20Contrato%20Front-end.md).
...
- Contrato: [API - Contrato Front-end.md](../../Contrato%20Front-end/API%20-%20Contrato%20Front-end.md)
- Layout: `Layout/Hi-fi Desktop` e `Layout/Hi-fi Mobile`
- Convenções de código: [../README.md](../../../../Frontend/CLAUDE.md)
...
[Pendencias Backend.md](../../API/Pendencias%20Backend.md).
...
1. **A janela de parcelados é de 24 meses.** A lista do mês filtra por
   ...
   em [Pendencias Backend.md](../../API/Pendencias%20Backend.md) — é a única
