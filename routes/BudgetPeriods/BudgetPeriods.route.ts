...
BudgetPeriods_route.put("/Base/BudgetPeriods/IdBudgetPeriod=:IdBudgetPeriod", BudgetPeriods_schema.update, AsyncHandler(BudgetPeriods_controller.update))

//  Delete físico: o período é plano, não lançamento. Ver sections/DELETE/remove.ts.
BudgetPeriods_route.delete("/Base/BudgetPeriods/IdBudgetPeriod=:IdBudgetPeriod", BudgetPeriods_schema.remove, AsyncHandler(BudgetPeriods_controller.remove))
