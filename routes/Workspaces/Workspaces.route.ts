...
Workspaces_route.post("/Base/Workspaces/switch", Workspaces_schema.switch, AsyncHandler(Workspaces_controller.switch))

//  Sem IdWorkspace no caminho: edita o workspace selecionado na sessão.
Workspaces_route.put("/Base/Workspaces", Workspaces_schema.update, AsyncHandler(Workspaces_controller.update))
